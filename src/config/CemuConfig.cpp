...
XMLConfigParser CemuConfig::Load(XMLConfigParser& parser)
{
	...
	emulated_usb_devices.emulate_usb_keyboard = usbdevices.get("EmulateUsbKeyboard", emulated_usb_devices.emulate_usb_keyboard);
...
XMLConfigParser CemuConfig::Save(XMLConfigParser& parser)
{
	...
	usbdevices.set("EmulateUsbKeyboard", emulated_usb_devices.emulate_usb_keyboard.GetValue());
